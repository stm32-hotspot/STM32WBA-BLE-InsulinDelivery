...
#define GAP_APPEARANCE_GENERIC_INSULIN_PUMP                               0x0D40
#undef CFG_GAP_APPEARANCE
#define CFG_GAP_APPEARANCE                 (GAP_APPEARANCE_GENERIC_INSULIN_PUMP)
...
typedef enum
{
  ...
  CFG_TASK_IDS_SRCP_ID,
  CFG_TASK_IDS_CCP_ID,
  CFG_TASK_IDS_CCP_PENDING_ID,
