...
CTS_APP_ConnHandleNotEvt_t CTSHandleNotification;
BAS_APP_ConnHandleNotEvt_t BASHandleNotification;
IDS_APP_ConnHandleNotEvt_t IDSHandleNotification;
IAS_APP_ConnHandleNotEvt_t IASHandleNotification;
BMS_APP_ConnHandleNotEvt_t BMSHandleNotification;

static char a_GapDeviceName[] = {  'I', 'n', 's', 'u', 'l', 'i', 'n', ' ', 'D', 'e', 'l', 'i', 'v', 'e', 'r', 'y' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[28] =
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'I', 'D', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_APPEARANCE, 0x00, 0x00 /* UNKNOWN_APPEARANCE */,
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x3A, 0x18,
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      CTSHandleNotification.EvtOpcode = CTS_DISCON_HANDLE_EVT;
      BASHandleNotification.EvtOpcode = BAS_DISCON_HANDLE_EVT;
      IDSHandleNotification.EvtOpcode = IDS_DISCON_HANDLE_EVT;
      IASHandleNotification.EvtOpcode = IAS_DISCON_HANDLE_EVT;
      ...
      CTSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      BASHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      IDSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      IASHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      ...
      CTS_APP_EvtRx(&CTSHandleNotification);
      BAS_APP_EvtRx(&BASHandleNotification);
      IDS_APP_EvtRx(&IDSHandleNotification);
      IAS_APP_EvtRx(&IASHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          CTSHandleNotification.EvtOpcode = CTS_CONN_HANDLE_EVT;
          BASHandleNotification.EvtOpcode = BAS_CONN_HANDLE_EVT;
          IDSHandleNotification.EvtOpcode = IDS_CONN_HANDLE_EVT;
          IASHandleNotification.EvtOpcode = IAS_CONN_HANDLE_EVT;
          ...
          CTSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          BASHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          IDSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          IASHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          CTSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          BASHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          IDSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          IASHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_INSULIN_DELIVERY; /* FW ID */
...
#else
  IDS_SRCP_InitSingleActiveBolus();
  IDS_SRCP_SetNoActiveBasalRateDelivery();
#endif
  return;
}
