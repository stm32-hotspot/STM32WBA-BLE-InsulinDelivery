...
} /* end of BMS_BMCP_RequestHandler() */
/* USER CODE END PF */
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
      ...
      switch(p_blecore_evt->ecode)
      {
        ...
        case ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE:
        {
          ...
          {
            return_value = SVCCTL_EvtAckFlowEnable;
            /*USER CODE BEGIN Service6_Char_1_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE */
            ...
            {
              if((p_write_perm_req->Data_Length > 1) &&
                 (p_write_perm_req->Data_Length == sizeof(AuthCode) + 1))
              {
                i = 1;
            ...
            /*USER CODE END Service6_Char_1_ACI_GATT_WRITE_PERMIT_REQ_VSEVT_CODE*/
          } /*if(p_write_perm_req->Attribute_Handle == (BMS_Context.BmcpCharHdle + CHARACTERISTIC_VALUE_ATTRIBUTE_OFFSET))*/
